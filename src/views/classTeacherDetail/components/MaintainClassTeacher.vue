<template>
  <div class="app-container">
    <el-button :disabled="!this.multipleSelection || this.multipleSelection.length === 0" type="primary" @click="addTeachers">添加</el-button>
      <!-- <el-button @click="toggleSelection([tableData[1], tableData[2]])">切换第二、第三行的选中状态</el-button>
      <el-button @click="toggleSelection()">取消选择</el-button> -->
      <el-table ref="multipleTable" :data="list" v-loading="listLoading" tooltip-effect="dark" border fit max-height="600px"
...
<script>
  export default {
    ...
    methods: {
      addTeachers() {
        this.api({
          url: "/schoolClass/addTeacher",
          method: "post",
          data: {classId: this.classId, teacherIds: this.multipleSelection.map(obj => {return obj.id}) }
        }).then(() => {
          this.getList();
          this.$emit('afterAddTeacher')
        })
      },
      removeTeachers() {
      ...
      getList() {
        ...
        this.api({
          url: "/teacher/listNoClassTeacher",
          method: "get",
