package com.chenyc.example.config.filter;

import com.chenyc.example.config.annotation.Logical;
import com.chenyc.example.config.annotation.RequiresPermissions;
import com.chenyc.example.config.exception.UnauthorizedException;
import com.chenyc.example.dto.session.SessionUserInfo;
import com.chenyc.example.service.TokenService;
...
public class PermissionAspect {
    ...
    @Before("@annotation(com.chenyc.example.config.annotation.RequiresPermissions)")
